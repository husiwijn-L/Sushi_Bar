    ...
    public partial class CreateDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DishIngredient", x => new { x.IngredientsId, x.IngredientsId1 });
                    table.ForeignKey(
                        name: "FK_DishIngredient_Dish_IngredientsId",
                        column: x => x.IngredientsId,
                        principalTable: "Dish",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DishIngredient_Ingredient_IngredientsId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DishIngredient_IngredientsId1",
