...
namespace Sushi_Bar.Controllers
{
    public class DishesController : Controller
    {
        ...
        public DishesController(Sushi_BarContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string searchString)
        {
            ...
            var movies = from m in _context.Dish
                         select m;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Price")] Dish dish)
        {
            if (id != dish.Id)
            {
                return NotFound();
